...
// DATA BARU: Update sampai Nov 2025
const data = [
  ...
  { tahun: '2025', ukt: 19.5, gaji: 4.7 }, // <--- DATA TERBARU 2025 (Meroket!)
];
...
export default function ChartUKT() {
  ...
  if (!isMounted) {
    return (
      <div className="w-full h-[350px] p-4 bg-gray-100 rounded-lg animate-pulse flex items-center justify-center">
        <span className="text-gray-400">Memuat Data UKT 2025...</span>
      </div>
    );
  }

  return (
    <div className="w-full h-[350px] p-4 bg-white rounded-lg shadow-sm border border-gray-100 my-6">
